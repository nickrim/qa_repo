BEGIN{
  puts
  name = "Nick Krimnus"
  description = "Test cases automation on application Sign Up v1 "
...
puts "=========================================="
puts "========================="
# = Test Case: Email Address required field verification
...
if browser.url=="http://www.alegro.com/qa/apps/sign_up/v1/submit.asp"
  puts "TEST CASE TC-01.30: Email Address required field verification - FAIL"
else
  puts "TEST CASE TC-01.30: Email Address required field verification - PASS"
end
